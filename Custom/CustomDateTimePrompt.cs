...
namespace HotelBot.Custom
{
    public class CustomDateTimePrompt : Prompt<IList<DateTimeResolution>>
    {
        public CustomDateTimePrompt(string dialogId, PromptValidator<IList<DateTimeResolution>> validator = null, string defaultLocale = null)
